 ...
 */
export declare type NextMsgRequest = {
    /**
...
export declare type DirectMsgRequest = SeqMsgRequest | LastForMsgRequest | NextMsgRequest;
/**
...
export declare type ExternalStream = {
    /**
...
export declare type KvWatchOptions = {
    /**
...
export declare type ObjectStoreLink = {
    bucket: string;
    name?: string;
};
export declare type ObjectStoreMetaOptions = {
    link?: ObjectStoreLink;
    max_chunk_size?: number;
};
export declare type ObjectStoreMeta = {
    name: string;
    description?: string;
    headers?: MsgHdrs;
...
export declare type ObjectStoreStatus = {
    bucket: string;
    description: string;
    ttl: Nanos;
    storage: StorageType;
 ...
 */
export declare type ObjectStoreInfo = ObjectStoreStatus;
...
export declare type ObjectResult = {
    info: ObjectInfo;
